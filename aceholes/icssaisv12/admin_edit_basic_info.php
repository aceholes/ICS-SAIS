	...
	<body>
		<form name="admin_edit_basic_info" action="admin_edit_basic_info_redirect.php" method="post"/>
			...
			<table>
				<tr>
					<td>HOME ADDRESS</td>
					<td><input type="text" name="admin_edit_homeaddress" placeholder="Home Address" value="<?php print $ahaddr;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE ADDRESS</td>
					<td><input type="text" name="admin_edit_collegeaddress" placeholder="College Address" value="<?php print $acaddr;?>"/></td>
				</tr>
				<tr>
					<td>HOME CONTACT NO.</td>
					<td><input type="number" name="admin_edit_homecontact" placeholder="Home Address Contact No." value="<?php print $ahcontact;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE CONTACT NO.</td>
					<td><input type="number" name="admin_edit_collegecontact" placeholder="College Address Contact No." value="<?php print $accontact;?>"/></td>
				</tr>
				<tr>
					<td>MOBILE NO.</td>
					<td><input type="number" name="admin_edit_mobile" placeholder="Mobile No." value="<?php print $amobile;?>"/></td>
				</tr>
				<tr>
					<td>EMAIL ADDRESS</td>
					<td><input type="text" name="admin_edit_emailaddress" placeholder="Email Address" value="<?php print $aemail;?>"/></td>
				</tr>
