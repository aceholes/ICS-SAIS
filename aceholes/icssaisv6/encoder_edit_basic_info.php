	...
	<body>
		<form name="encoder_edit_basic_info" action="encoder_edit_basic_info_redirect.php" method="post"/>
			...
			<table>
				<tr>
					<td>HOME ADDRESS</td>
					<td><input type="text" name="encoder_edit_homeaddress" placeholder="Home Address" value="<?php print $ehaddr;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE ADDRESS</td>
					<td><input type="text" name="encoder_edit_collegeaddress" placeholder="College Address" value="<?php print $ecaddr;?>"/></td>
				</tr>
				<tr>
					<td>HOME CONTACT NO.</td>
					<td><input type="number" name="encoder_edit_homecontact" placeholder="Home Address Contact No." value="<?php print $ehcontact;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE CONTACT NO.</td>
					<td><input type="number" name="encoder_edit_collegecontact" placeholder="College Address Contact No." value="<?php print $eccontact;?>"/></td>
				</tr>
				<tr>
					<td>MOBILE NO.</td>
					<td><input type="number" name="encoder_edit_mobile" placeholder="Mobile No." value="<?php print $emobile;?>"/></td>
				</tr>
				<tr>
					<td>EMAIL ADDRESS</td>
					<td><input type="text" name="encoder_edit_emailaddress" placeholder="Email Address" value="<?php print $eemail;?>"/></td>
				</tr>
			...
			<a href ="encoder_add_basic_info.php">Add</a><br/>
