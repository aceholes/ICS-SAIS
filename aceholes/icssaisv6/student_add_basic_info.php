...
<html>
	...
	<body>
		<form name="student_add_basic_info"/>
			...
			<table>
				...
				<tr>
					<td>EMAIL ADDRESS</td>
					<td><input type="text" name="student_add_emailaddress" placeholder="Email Address"/></td>
				</tr>
				
				<tr>
					<td><input type="submit" name="student_add_submit" value="Submit"/></td>
				</tr>
			</table>
