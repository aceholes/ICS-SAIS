...
<html>
	...
	<body>
		<form name="instructor_delete_basic_info"/>
			...
			<table>
				<tr>
					<td>HOME ADDRESS</td>
					<td><input type="text" name="instructor_delete_homeaddress" placeholder="Home Address"/></td>
				</tr>
				<tr>
					<td>COLLEGE ADDRESS</td>
					<td><input type="text" name="instructor_delete_collegeaddress" placeholder="College Address"/></td>
				</tr>
				<tr>
					<td>HOME CONTACT</td>
					<td><input type="number" name="instructor_delete_homecontact" placeholder="Home Address Contact No."/></td>
				</tr>
				<tr>
					<td>COLLEGE CONTACT</td>
					<td><input type="number" name="instructor_delete_collegecontact" placeholder="College Address Contact No."/></td>
				</tr>
				<tr>
					<td>MOBILE NO.</td>
					<td><input type="number" name="instructor_delete_mobile" placeholder="Mobile No."/></td>
				</tr>
				<tr>
					<td>
						<input type="submit" name="instructor_delete_submit" value="Submit"/>
					</td>
				</tr>
			</table>
			...
			<a href ="instructor_add_basic_info.php">Add</a><br/>
