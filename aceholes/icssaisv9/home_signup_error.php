			...
			<h2>Sign-up</h2>
				<table>
					<tr>
						...
						<?php
							if($_SESSION["signup_role_error"]==1){
					...
					<tr>
						...
						<?php
							if($_SESSION["signup_number_error"]==1){
								echo "<td>Please fill out your number.</td>";
								$_SESSION["signup_number_error"]=0;
							}

							if($_SESSION["signup_number_invalid"]==1){
					...
					<tr>
						...
						<?php
							if($_SESSION["signup_gender_error"]==1){
					...
					<tr>
						...
						<?php
							if($_SESSION["signup_username_error"]==1){
								echo "<td>Please fill out your username.</td>";
								$_SESSION["signup_username_error"]=0;
							}

							if($_SESSION["signup_username_invalid"]==1){
					...
					<tr>
						...
						<?php
							if($_SESSION["signup_password_error"]==1){
					...
					<tr>
						...
						<?php
							if($_SESSION["signup_password_retype_error"]==1){
