...
<html>
	...
	<body>
		<form name="student_view_approved_ge_mst"/>
			...
			<a href="student_view_allowed_ge_ah.php">AH</a>&nbsp;&nbsp;&nbsp;
			<a href="student_view_allowed_ge_ssp.php">SSP</a> &nbsp;&nbsp;&nbsp;
			<b>Mathematics, Science and Technology</b> <br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select geno, getitle, gedesc, geunits from ge where gedomain='MST'");
