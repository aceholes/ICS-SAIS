...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cas_dss"/>
			...
			<b>Department of Social Sciences</b><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CAS' and eldept='DSS'");
