...
<html>
	...
	<body>
		<form name="admin_instructor_sentbox"/>
			<!-- top right po	-->
			...
			<a href="admin_student_sentbox.php">Student</a>&nbsp;&nbsp;&nbsp;
			<b>Instructor</b> <br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select a.aisdate, a.aissubject, a.aisbody, b.ifname, b.ilname, b.iemail 
												from admin_instructor_sentbox a, instructor b
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select a.aisdate, a.aissubject, a.aisbody, b.ifname, b.ilname, b.iemail 
												from admin_instructor_sentbox a, instructor b
												where b.ifname = (select ifname from instructor where ino=a.ino) and
												b.ilname = (select ilname from instructor where ino=a.ino)
												and b.ino=a.ino");
						...
						while($row2 = odbc_fetch_array($result2)) {
							echo "<tr>";
								echo "<td>".$row2["AISDATE"]."</td>";
								echo "<td>".$row2["IFNAME"]." ".$row2["ILNAME"]."</td>";
								echo "<td>".$row2["IEMAIL"]."</td>";
								echo "<td>".$row2["AISSUBJECT"]."</td>";
								echo "<td>".$row2["AISBODY"]."</td>";
							echo "</tr>";
						}
						echo "</table><br/>";
					}else{
