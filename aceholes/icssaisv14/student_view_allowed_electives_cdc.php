...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cdc"/>
			...
			<b>College of Development Communication</b> &nbsp;&nbsp;&nbsp;
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CDC'");
