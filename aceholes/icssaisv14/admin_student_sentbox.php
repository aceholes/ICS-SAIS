...
<html>
	...
	<body>
		<form name="admin_student_sentbox"/>
			<!-- top right po	-->
			...
			<b>Student</b> &nbsp;&nbsp;&nbsp;
			<a href="admin_instructor_sentbox.php">Instructors</a><br/>			
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select a.assdate, a.asssubject, a.assbody, b.sfname, b.slname, b.semail 
												from admin_student_sentbox a, student b
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select a.assdate, a.asssubject, a.assbody, b.sfname, b.slname, b.semail 
													from admin_student_sentbox a, student b
													where b.sfname = (select sfname from student where sno=a.sno) and
													b.slname = (select slname from student where sno=a.sno)
													and b.sno=a.sno");
						...
						while($row2 = odbc_fetch_array($result2)) {
							echo "<tr>";
								echo "<td>".$row2["ASSDATE"]."</td>";
								echo "<td>".$row2["SFNAME"]." ".$row2["SLNAME"]."</td>";
								echo "<td>".$row2["SEMAIL"]."</td>";
								echo "<td>".$row2["ASSSUBJECT"]."</td>";
								echo "<td>".$row2["ASSBODY"]."</td>";
							echo "</tr>";
						}
						echo "</table><br/>";
					}else{
