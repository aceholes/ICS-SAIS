...
<html>
	...
	<body>
		<form name="encoder_adviser" action="encoder_choose_sno_redirect.php" method="post">
			<!-- top right po	-->
			...
			<?php
				...
				if($conn){
					...
					if($flag != 0){
						...
						echo "</select><br/>";	
						echo "<input type='submit' name='encoder_choose_sno_adviser_submit' value='Submit'/><br/>";
					}else{
