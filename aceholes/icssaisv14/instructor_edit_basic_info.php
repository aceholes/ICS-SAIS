	...
	<body>
		<form name="instructor_edit_basic_info" action="instructor_edit_basic_info_redirect.php" method="post"/>
			...
			<table>
				<tr>
					<td>HOME ADDRESS</td>
					<td><input type="text" name="instructor_edit_homeaddress" autofocus="autofocus" autocomplete="on" placeholder="Home Address" value="<?php print $ihaddr;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE ADDRESS</td>
					<td><input type="text" name="instructor_edit_collegeaddress"  autocomplete="on" placeholder="College Address" value="<?php print $icaddr;?>"/></td>
				</tr>
				<tr>
					<td>HOME CONTACT NO.</td>
					<td><input type="number" name="instructor_edit_homecontact"  autocomplete="on" pattern="^[0-9]{7,11}$" placeholder="Home Address Contact No." value="<?php print $ihcontact;?>"/></td>
				</tr>
				<tr>
					<td>COLLEGE CONTACT NO.</td>
					<td><input type="number" name="instructor_edit_collegecontact" autocomplete="on" pattern="^[0-9]{7,11}$" placeholder="College Address Contact No." value="<?php print $iccontact;?>"/></td>
				</tr>
				<tr>
					<td>MOBILE NO.</td>
					<td><input type="number" name="instructor_edit_mobile"  autocomplete="on" pattern="^[0-9]{7,11}$" placeholder="Mobile No." value="<?php print $imobile;?>"/></td>
				</tr>
				<tr>
					<td>EMAIL ADDRESS</td>
					<td><input type="email" name="instructor_edit_emailaddress" required="required"  autocomplete="on" pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" placeholder="Email Address" value="<?php print $iemail;?>"/></td>
				</tr>
