...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cfnr"/>
			...
			<b>College of Forestry and Natural Resources</b><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CFNR'");
