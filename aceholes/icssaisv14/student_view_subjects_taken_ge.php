...
<html>
	...
	<body>
		<form name="student_view_subjects_taken_ge"/>
			...
			<a href="student_view_subjects_taken_elective.php">Elective</a><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gtgrade, b.gtsem, b.gtyear from ge a, ge_taken b where a.geno = b.geno and sno = '".$_SESSION["no"]."'");
					...
					if($flag2 != 0){
						$result2 = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gtgrade, b.gtsem, b.gtyear from ge a, ge_taken b where a.geno = b.geno and sno = '".$_SESSION["no"]."'");
						...
						echo "<table border='1'>";
							...
							while($row2 = odbc_fetch_array($result2)) {
								echo "<tr>";
									...
									echo "<td>".$row2["GTGRADE"]."</td>";
									echo "<td>".$row2["GTSEM"]." Semester / A.Y. ".$row2["GTYEAR"]."</td>";
								echo "</tr>";
							}
							echo "</table><br/>";
					}else{
