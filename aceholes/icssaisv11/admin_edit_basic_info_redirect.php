	...
	if (isset($_POST["admin_edit_submit"])){
		...
		if($conn){
			if($ahaddr!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set ahaddr = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($acaddr!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set acaddr = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($ahcontact!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set ahcontact = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($accontact!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set accontact = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($amobile!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set amobile = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($aemail!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update administrator set aemail = NULL where afname = '".htmlspecialchars($_SESSION['fname'])."' and alname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
