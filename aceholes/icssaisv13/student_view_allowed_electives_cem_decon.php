...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cem_decon"/>
			...
			<br/><br/><a href="student_view_allowed_electives_cem_dabm.php">DAbM</a> &nbsp;&nbsp;&nbsp;
			<b>Department of Economics</b><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CEM' and eldept='DECON'");
