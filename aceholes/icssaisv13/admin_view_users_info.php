...
<html>
	...
	<body>
		<form name="admin_view_users_info" action="admin_delete_user_redirect.php" method="post"/>
			<!-- top right po	-->
				...
				if(isset($_GET['stdnum'])){
					...
					if($conn){
						...
						while($row = odbc_fetch_array($result)) {
							$_SESSION["delete_number"]=$row["SNO"];
					...
					if($conn){
						...
						echo "<table border='1'>";
						while($row = odbc_fetch_array($result)) {
							$_SESSION["delete_number"]=$row["INO"];
					...
					if($conn){
						...
						echo "<table border='1'>";
						while($row = odbc_fetch_array($result)) {
							$_SESSION["delete_number"]=$row["ENO"];
			...
			<input type="submit" name="admin_delete_user" value="Delete User"/><br/><br/>
