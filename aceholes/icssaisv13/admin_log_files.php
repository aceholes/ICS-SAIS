	...
	<body>
		<form name="admin_log_files"/>
			...
			<?php
				...
				if($conn){
					$result = odbc_exec($conn, "select sno, slactivity, sltime from student_log");
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select sno, slactivity, sltime from student_log");
						echo "<table border='1'>";
						echo "<tr>";
						...
						while($row2 = odbc_fetch_array($result2)) {
							echo "<tr>";
								echo "<td>".$row2["SNO"]."</td>";
								echo "<td>".$row2["SLACTIVITY"]."</td>";
								echo "<td>".$row2["SLTIME"]."</td>";
							echo "</tr>";
						}
						echo "</table><br/><br/>";	
					}else{
