...
<html>
	...
	<body>
		<form name="instructor_messages_sentbox">
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select isdate, issubject, isbody from instructor_sentbox where ino='".$_SESSION["no"]."'");
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select isdate, issubject, isbody from instructor_sentbox where ino='".$_SESSION["no"]."'");
						echo "<table border='1'>";
						echo "<tr>";
							echo "<td><b>DATE</b></td>";
						...
						while($row2 = odbc_fetch_array($result2)) {
							echo "<tr>";
								echo "<td>".$row2["ISDATE"]."</td>";
								echo "<td>".$row2["ISSUBJECT"]."</td>";
								echo "<td>".$row2["ISBODY"]."</td>";
							echo "</tr>";
						}
						echo "</table><br/>";
					}else{
