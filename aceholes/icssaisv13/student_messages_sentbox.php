...
<html>
	...
	<body>
		<form name="student_messages_sentbox">
			...
			<?php
				...
				if($conn){
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select ssdate, sssubject, ssbody from student_sentbox where sno='".$_SESSION["no"]."'");
						...
						while($row2 = odbc_fetch_array($result2)) {
							echo "<tr>";
								echo "<td>".$row2["SSDATE"]."</td>";
								echo "<td>".$row2["SSSUBJECT"]."</td>";
								echo "<td>".$row2["SSBODY"]."</td>";
							echo "</tr>";
						}
						echo "</table><br/>";
					}else{
