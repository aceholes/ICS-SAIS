	...
	if (isset($_POST["encoder_edit_submit"])){
		...
		if($conn){
			if($ehaddr!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set ehaddr = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($ecaddr!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set ecaddr = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($ehcontact!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set ehcontact = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($eccontact!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set eccontact = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($emobile!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set emobile = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
			...
			if($eemail!=""){
				...
				odbc_autocommit($conn, TRUE);
				odbc_exec($conn, "update encoder set eemail = NULL where efname = '".htmlspecialchars($_SESSION['fname'])."' and elname = '".htmlspecialchars($_SESSION['lname'])."'");
			}
