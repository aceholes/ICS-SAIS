...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cas_imsp"/>
			...
			<b>Institute of Mathematical Science and Physics</b> &nbsp;&nbsp;&nbsp;
			<a href="student_view_allowed_electives_cas_instat.php">INSTAT</a> &nbsp;&nbsp;&nbsp;
			<a href="student_view_allowed_electives_cas_dhum.php">DHUM</a> &nbsp;&nbsp;&nbsp;
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CAS' and eldept='IMSP'");
