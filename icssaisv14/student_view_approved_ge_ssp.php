...
<html>
	...
	<body>
		<form name="student_view_approved_ge_ssp"/>
			...
			<b>Social Sciences and Philosophy</b>&nbsp;&nbsp;&nbsp;
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gasem, b.gayear from ge a, ge_approved b where a.geno = b.geno and b.sno = '".$_SESSION["no"]."' and a.gedomain='SSP'");
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gasem, b.gayear from ge a, ge_approved b where a.geno = b.geno and b.sno = '".$_SESSION["no"]."' and a.gedomain='SSP'");
						echo "<table border='1'>";
						echo "<tr>";
