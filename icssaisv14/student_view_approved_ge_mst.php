...
<html>
	...
	<body>
		<form name="student_view_approved_ge_mst"/>
			...
			<a href="student_view_approved_ge.php">AH</a> &nbsp;&nbsp;&nbsp;
			<a href="student_view_approved_ge_ssp.php">SSP</a>&nbsp;&nbsp;&nbsp;
			<b>Mathematical Science and Technology</b><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gasem, b.gayear from ge a, ge_approved b where a.geno = b.geno and b.sno = '".$_SESSION["no"]."' and a.gedomain='MST'");
					...
					if($flag != 0){
						$result2 = odbc_exec($conn, "select a.geno, a.getitle, a.gedesc, a.geunits, b.gasem, b.gayear from ge a, ge_approved b where a.geno = b.geno and b.sno = '".$_SESSION["no"]."' and a.gedomain='MST'");
						echo "<table border='1'>";
						echo "<tr>";
