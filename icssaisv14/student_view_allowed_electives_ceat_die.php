...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_ceat_die"/>
			...
			<b>College of Engineering and Agro-Industrial Technology</b> &nbsp;&nbsp;&nbsp;
			<a href="student_view_allowed_electives_cfnr.php">CFNR</a><br/><br/>
			
			<b>Department of Industrial Engineering</b><br/><br/>
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CEAT' and eldept='DIE'");
