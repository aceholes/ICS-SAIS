...
<html>
	...
	<body>
		<form name="admin_add_user_encoder_more" action="admin_add_user_encoder_more_redirect.php" method="post"/>
			<!-- top right po	-->
			...
			<table>
				...
				<tr>
					<td>
						<input type="text" name="admin_add_user_role" autocomplete="on" required="required" placeholder="Role"/>
						&nbsp;&nbsp;<font color="red">*</font>
					</td>
				</tr>
				<tr>
