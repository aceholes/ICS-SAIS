...
<html>
	...
	<body>
		<form name="student_view_allowed_electives_cas_ics"/>
			...
			<br/><br/><b>Institute of Computer Science</b> &nbsp;&nbsp;&nbsp;
			...
			<?php
				...
				if($conn){
					...
					$result = odbc_exec($conn, "select elno, eltitle, eldesc, elunits from elective where elcollege='CAS' and eldept='ICS'");
